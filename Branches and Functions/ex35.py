...
def gold_room():
    ...
    choice = input("> ")
    # it takes whatever the person adds and assign it to the
    # choice variable 
    ...
    if how_much < 50:
        ...
        dead("You greedy bastard! Your're dead ")
...
def cthulhu_room():
    ...
    print("She, he, whatever stares at you and you go insane")
    print("Do you flee for your life or eat your head? ")

    choice = input("> ")

    if "flee" in choice:
        # this looks at the text you entered anf i the keyword
